...
from .views import HomeView, ArticleDetailView, AddReviewView, UpdateReviewView, DeleteReviewView, AddCategoryView, CategoryView, HeroView, AddHeroView
...
urlpatterns = [
    ...
    path('add_hero/', AddHeroView.as_view(), name='add_hero'),
